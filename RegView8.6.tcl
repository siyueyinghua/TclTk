...
proc updatebitcheckbuttontext { group n } {
    ...
    set valuedecnew [scan "$valuebinfullnew" %lb]
    set valuebin [format %lb $valuedecnew]
}
...
proc updateonset {setbitswidth} {
    ...
    if {$setbitswidth != ""} {
        ...
        ## set valuedec [format %lu 0x${valuehex}]
        ## set valueoct [format %lo 0x${valuehex}]
        ## set valuebin [format %lb 0x${valuehex}]
...
proc updateonshift {direction shiftbitswidth} {
    ...
    if {$shiftbitswidth != "" && $valuebin != ""} {
        ...
        if {$direction == "left"} {
            set valuebin [format %lb [expr 0b$valuebin << $shiftbitswidth]]
...
proc tracerset args {
    ...
    if {$variabletype == "setvaluevarhex"} {
        if {$setvaluevarhex == ""} {
            ...
            set setvaluevarhex [format %lX [scan $setvaluevarhex %lX]]
            set setvaluevardec [format %lu 0x$setvaluevarhex]
            set setvaluevarbin [format %lb 0x$setvaluevarhex]
        }
        ...
        if {$setvaluevardec == ""} {
            ...
            set setvaluevardec [scan $setvaluevardec %ld]
            set setvaluevarhex [format %lX [scan $setvaluevardec %ld]]
            set setvaluevarbin [format %lb [scan $setvaluevardec %ld]]
        }
        ...
        if {$setvaluevarbin == ""} {
            ...
            set setvaluevarbin [format %lb [scan $setvaluevarbin %lb]]
            set setvaluevarhex [format %lX 0b$setvaluevarbin]
            set setvaluevardec [format %lu 0b$setvaluevarbin]
        }
    }
...
proc tracerentry args {
    ...
    if {$variabletype == "valuehex"} {
        if {$valuehex == ""} {
            ...
            set valuehex [format %lX [scan $valuehex %lX]]
            set valuedec [format %lu 0x$valuehex]
            set valueoct [format %lo 0x$valuehex]
            set valuebin [format %lb 0x$valuehex]
        }
        ...
        if {$valuedec == ""} {
            ...
            set valuedec [scan $valuedec %ld]
            set valuehex [format %lX [scan $valuedec %ld]]
            set valueoct [format %lo [scan $valuedec %ld]]
            set valuebin [format %lb [scan $valuedec %ld]]
        }
        ...
        if {$valueoct == ""} {
            ...
            set valueoct [format %lo [scan $valueoct %lo]]
            set valuehex [format %lX 0o$valueoct]
            set valuedec [format %lu 0o$valueoct]
            set valuebin [format %lb 0o$valueoct]
        }
        ...
        if {$valuebin == ""} {
            ...
            set valuebin [format %lb [scan $valuebin %lb]]
            set valuehex [format %lX 0b$valuebin]
            set valuedec [format %lu 0b$valuebin]
            set valueoct [format %lo 0b$valuebin]
        }
    }
